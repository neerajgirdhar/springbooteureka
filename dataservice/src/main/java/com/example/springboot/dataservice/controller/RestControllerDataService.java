...
public class RestControllerDataService {

	private static final Logger log = LoggerFactory.getLogger(RestControllerDataService.class);
	...
	public RestControllerDataService(CustomerRepository customerRepository)
	{
	...
	//	this.lbRestTemplate =lbRestTemplate;
	 ...
	 @RequestMapping(method = RequestMethod.GET, path = "/getUserAccount/{userName}", produces = MediaType.APPLICATION_JSON_VALUE)
		...
		// List<Customer> customersFromDB =customerRepository.findAll();
		 ...
		 while(strTokenizer.hasMoreElements())
		 {
			...
			// String url = "http://localhost:4201/dataservice2/getCoin/"+splitArray[0];
			
			 ServiceInstance instance = loadBalancer.choose("spring-boot-job3");
			 URI uri = instance.getUri();
			 String url1 = String.format("%s%s/"+splitArray[0], uri,"/dataservice2/getCoin");
			 log.info("url1---->"+url1);
	 ...
	 @RequestMapping(method = RequestMethod.POST, path = "/addUserAccount/{userName}/{coins}", produces = MediaType.APPLICATION_JSON_VALUE)
	 ...
	 @RequestMapping(method = RequestMethod.DELETE, path = "/deleteUserAccount/{userName}", produces = MediaType.APPLICATION_JSON_VALUE)
	 ...
	 @RequestMapping(method = RequestMethod.PUT, path = "/updateUserAccount/{userName}/{coins}", produces = MediaType.APPLICATION_JSON_VALUE)
