...
public class RestControllerUserService {
	...
	public CustomerVO getCustomerrDetails(@PathVariable String userName)
		...
		while (strTokenizer.hasMoreElements()) {
			...
			coins_TotalValue = Integer.parseInt(splitArray[1])
					* Integer.parseInt(coinVO.getCoin_price());
	...
	public boolean addCustomerrDetails(@PathVariable String userName,
			@PathVariable String coins) throws IOException,
	...
	public boolean deleteCustomerrDetails(@PathVariable String userName)
			throws IOException, InterruptedException {
		boolean success = true;
	...
	public boolean updateCustomerrDetails(@PathVariable String userName,
			@PathVariable String coins) throws IOException,
			InterruptedException {
